...
namespace Guest_Houses_Reservations.Controllers
{
    public class GuestsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,Phone")] Guest guest)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Phone")] Guest guest)
        {
            if (id != guest.Id)
            {
                return NotFound();
